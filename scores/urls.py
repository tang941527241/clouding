...
from .views import upload_scores, export_scores, ScoreListView, ScoreCreateView, ScoreUpdateView, ScoreDeleteView, \
    ScoreDeleteMultipleView, ScoreDetailView, MyScoreListView
