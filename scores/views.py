...
def export_scores(request):
    ...
    if request.method == 'POST':
        ...
        for score in scores:
            ws.append(
                [score.title, score.grade.grade_name, score.student_name, score.student_number, score.chinese_score,
                 score.math_score, score.english_score])
...
class ScoreCreateView(BaseScoreView, CreateView):
    ...
    def form_invalid(self, form):
        ...
        errors = {field: [{'message': error, 'code': ''} for error in errors_list] for field, errors_list in
                  form.errors.items()}
